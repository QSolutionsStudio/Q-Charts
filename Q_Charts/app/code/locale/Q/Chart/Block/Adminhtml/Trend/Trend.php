 ...
 */
class Q_Chart_Block_Adminhtml_Trend_Trend
    extends Mage_Catalog_Block_Product_Abstract
{
    ...
    /**
     * @param $productId
     * @return Q_Chart_Model_Relatedproduct
     */
    protected function getConfigurableProduct($productId)
    {
        return Mage::getModel('q_chart/relatedproduct')->getCollection()
    ...
    protected function getOrderItemCollection()
    {
        ...
        if (!is_null($this->_sku)) {
            ...
            foreach ($relatedProducts as $product) {
                if ($relatedProducts instanceof Q_Chart_Model_Resource_Relatedproduct_Collection) {
