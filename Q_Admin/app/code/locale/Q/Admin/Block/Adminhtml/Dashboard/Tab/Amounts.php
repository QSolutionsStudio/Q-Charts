 ...
 */
class Q_Admin_Block_Adminhtml_Dashboard_Tab_Amounts
    extends Q_Admin_Block_Adminhtml_Dashboard_Graph
{
    /**
     *
     */
    ...
    {
        $this->setTemplate('q_admin/dashboard/amounts/diagram.phtml');
        parent::_construct();
    }
